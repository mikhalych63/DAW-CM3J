...
curl -LJO https://github.com/HEnquist/camillagui-backend/releases/download/v2.1.1/camillagui.zip
if [ $? -ne 0 ]; then
...
curl -LJO https://github.com/HEnquist/camilladsp/releases/download/v2.0.3/$ARCHIVE_NAME
if [ $? -ne 0 ]; then
